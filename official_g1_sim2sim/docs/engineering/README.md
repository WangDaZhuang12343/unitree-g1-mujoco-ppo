...
| [ISAACLAB_ENVIRONMENT_REPORT.md](ISAACLAB_ENVIRONMENT_REPORT.md) | Isaac Sim/Lab版本、GPU验证、迁移接入与PPO冒烟结果 |
| [ISAACLAB_PRETRAIN_FINETUNE_REPORT.md](ISAACLAB_PRETRAIN_FINETUNE_REPORT.md) | DWA教师行为克隆、actor-only PPO微调与确定性验收结果 |
| [ISAACLAB_CURRICULUM_AND_GATE.md](ISAACLAB_CURRICULUM_AND_GATE.md) | Terrain课程、实验教师、自动Benchmark准入与训练机验收顺序 |
